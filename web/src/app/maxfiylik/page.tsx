...
const UPDATED = "17-sentyabr, 2026";
  ...
  return (
    <div className="student-lab-home pattern-page min-h-screen bg-surface-page">
      ...
      <main className="mx-auto max-w-3xl px-4 py-12">
        ...
        <div className="mt-6 rounded border border-line bg-white p-5 text-sm leading-relaxed">
          <strong>SpeakUp Lab:</strong> Nomiga o‘rgatish va xona laboratoriyasidagi
          javob matnlari faqat ochiq sahifa xotirasida ishlatiladi; SpeakUp serveriga
          yoki generativ AI xizmatiga yuborilmaydi. Bajarilgan mavzu/vazifa, ko‘rsatmalar
          soni va yakunlangan vaqt shu brauzerda saqlanadi. Sahifa yangilansa suhbat
