...
function ProfileForm({
  ...
  return (
    <div className="student-lab-home">
      <header className="hero-navy hero-photo-classroom px-4 py-8 text-white">
        <div className="mx-auto max-w-lg">
          ...
          <Link href="/student/lab" className="mt-4 inline-block text-sm text-white underline underline-offset-4">Avval Nomi laboratoriyasini sinab ko‘r →</Link>
        </div>
      </header>
